...
public class ApplyMeeting extends ActionSupport {
	...
	public String execute() throws Exception{
		...
		try {
			String url="jdbc:mysql://localhost:3306/我要去健身?characterEncoding=utf8&useSSL=false";
			conn = DriverManager.getConnection(url,"root","d19970414");
